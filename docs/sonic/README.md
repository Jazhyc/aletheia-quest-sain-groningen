...
**Start here:** `sonic_v3.md`. It is self-contained. You do not need any other
...
| document | subject |
| --- | --- |
| `sonic_v3.md` | **Current version.** Shared-trunk probe weights for nemotron and qwen. The notebook code is identical to v2.3.6. Self-contained. **Submitted 2026-07-25, result pending.** |
...
| `sonic_v2_DOCUMENTATION.md` | The v2 design in full. Superseded by `sonic_v3.md`. |
