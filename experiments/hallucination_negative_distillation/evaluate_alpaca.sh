#!/bin/bash
#SBATCH --job-name=aq-hallucination-eval
...
exec >"logs/slurm/hallucination_negative_distillation/eval-${SLURM_JOB_ID}.out" 2>&1
...
python experiments/hallucination_negative_distillation/evaluate_alpaca.py \
  ...
  --output-dir results/blackbox/hallucination_negative_distillation_v1/evaluation \
