#!/bin/bash
#SBATCH --job-name=aq-qwen-ret-eval
...
LOG="logs/slurm/wikidata_rag/qwen-retriever-eval-${SLURM_JOB_ID}.out"
exec >"${LOG}" 2>&1
...
python -m experiments.wikidata_rag.evaluate_qwen_retriever_rank1 \
  --adapter-dir results/blackbox/wikidata_qwen_retriever_rank1_v1/adapter \
  ...
  --output-dir results/blackbox/wikidata_qwen_retriever_rank1_v1/evaluation
