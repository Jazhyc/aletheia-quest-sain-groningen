#!/bin/bash
#SBATCH --job-name=aq-harm-choice
...
exec >"logs/slurm/liars_bench_distillation/harm-choice-${SLURM_JOB_ID}.out" 2>&1
...
python experiments/liars_bench_distillation/evaluate_action_prompt.py \
  ...
  --output-dir results/blackbox/liars_bench_pid_aug_v1/harm_choice_prompt_4500 \
