#!/bin/bash
#SBATCH --job-name=aq-q9-heavy-confirm
...
exec >"logs/slurm/liars_bench_distillation/q9-heavy-confirm-${SLURM_JOB_ID}.out" 2>&1
...
python experiments/liars_bench_distillation/evaluate_heavy_spectrum.py \
  ...
  --output-dir results/blackbox/liars_bench_qwen9_heavy_spectrum_confirmation_v1
