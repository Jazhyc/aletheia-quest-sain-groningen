#!/bin/bash
#SBATCH --job-name=aq-q27-heavy-spectrum
...
exec >"logs/slurm/liars_bench_distillation/q27-heavy-spectrum-${SLURM_JOB_ID}.out" 2>&1
...
python experiments/liars_bench_distillation/evaluate_heavy_spectrum.py \
  ...
  --output-dir results/blackbox/liars_bench_qwen27_heavy_spectrum_v1
