#!/bin/bash
#SBATCH --job-name=aq-phoenix-heavy-spectrum
...
exec >"logs/slurm/liars_bench_distillation/phoenix-heavy-spectrum-${SLURM_JOB_ID}.out" 2>&1
...
python experiments/liars_bench_distillation/evaluate_heavy_spectrum.py \
  ...
  --adapter submission/phoenix_wright_v2_adapter \
  --output-dir results/blackbox/liars_bench_phoenix_heavy_spectrum_v1
