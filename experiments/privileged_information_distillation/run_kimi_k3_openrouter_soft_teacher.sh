#!/bin/bash
# Cache Kimi K3 binary-margin supervision through OpenRouter.
...
METHOD="kimi_k3_fireworks_nothink_tvg_binary_logit_v1"
...
"${PYTHON}" \
  ...
  --dataset-name-contains varied-deception \
  --expected-rows 2880 \
  --source public_split_plus_kimi_k3_openrouter_binary_soft_target
