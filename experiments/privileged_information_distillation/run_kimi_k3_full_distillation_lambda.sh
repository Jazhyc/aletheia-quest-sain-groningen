#!/bin/bash
# Train and validate the full-data Kimi K3 binary-soft rank-16 student.
...
METHOD="qwen9b_kimi_k3_openrouter_tvg_soft_full_r16_lr5e5_ep2_v1"
BASE_CONFIG="pid_kimi_k3_openrouter_tvg_binary_soft_full_r16_ep2_v1"
